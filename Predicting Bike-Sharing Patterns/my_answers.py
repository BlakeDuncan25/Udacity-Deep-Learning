...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        self.activation_function = lambda x: 1 / (
            1 + np.exp(-x)
    ...
    def backpropagation(
        ...
        hidden_error_term = (
            np.dot(output_error_term, self.weights_hidden_to_output.T)
            * hidden_outputs
            * (1 - hidden_outputs)
        )
...
# Learning rate is by far most important hyperparameter
# Training loss below 0.09 AND Validation loss below 0.18
# LR: 0.1, HN: 10 - Validation loss 1.532
# LR: 0.2, HN: 10 - Validation loss 1.307
# LR: 0.4, HN: 10 - Validation loss 0.281
# LR: 0.8, HN: 10 - Training loss 0.07, Validation loss 0.157 WINNER
# LR: 1.6, HN: 10 - Validation loss 0.189
# LR: 0.8, HN: 15 - Validation loss 0.166
# LR: 0.8, HN: 8 - Validation loss 0.234
